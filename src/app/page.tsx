        ...
        <div className="grid grid-cols-2 gap-4 place-items-center mt-80">
          ...
          <article className="text-white text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg leading-relaxed">
              "Amidst the chaos of Wano, where samurai rise and legends fall,
              one man stands unshaken. With the will of D, the fire of a
              warrior, and the dream of a free world, Monkey D. Luffy steps
              forward. Kaido’s reign trembles, the drums of liberation echo, and
              the new era draws near. The pirate king’s journey has never burned
              brighter!"
            </p>
          </article>
        </div>
        <div className="grid grid-cols-2 gap-4 place-items-center mt-80">
          <article className="text-white text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg leading-relaxed">
              ...
              Push'— the will of the Akatsuki shakes the Hidden Leaf to its
              core. Buildings crumble, screams echo, and despair spreads like
              wildfire. The shinobi world stands frozen as Pain delivers his
              divine retribution. In this moment, Konoha’s greatest trial has
              begun, and only one stands against the storm."
            </p>
          </article>
          <InteractiveCards
            variant="third"
